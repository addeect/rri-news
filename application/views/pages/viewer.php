      ...
      <div class="row">
        <div class="col-sm-12">
          <div>
            ...
            <div class="action_button"><!--button class="btn btn-sm btn-success">SIMPAN</button><input type="button" class="btn btn-sm btn-warning" onclick="approve1()" value="APPROVE"--></div>
            <div class="action_button1"><a class="btn btn-sm btn-primary" href="<?php echo site_url('redaksi/daftar-berita-approved') ?>">KEMBALI</a></div>
          </div>
          <div>
