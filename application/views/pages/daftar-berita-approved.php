    ...
    <div class="col-sm-9 konten">
      <div class="row">
        <div class="col-sm-12">
          ...
          <form method="post" action="<?php echo site_url('redaksi/searchApproved') ?>">
          ...
          <ul class="nav nav-tabs">
            <li><a href="<?php echo site_url('redaksi/daftar-berita') ?>">Belum Disetujui</a></li>
            <li class="active"><a href="#" onclick="return false;">Disetujui </a></li>
          </ul>
          <br>
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody class="isi_tabel">
                <?php $start=1; foreach ($berita_approved as $data_berita) { ?>
