...
/*
    CAMINO-2 v1.0
    Created by : Adam Triamukti <Addeect Code Works>
*/
...
.te_section5{
  position: relative;
  background-image: url('<?php echo base_url("assets/img/ca_contact_us_bg4.jpg") ?>');
    background-repeat: no-repeat;
    background-size: auto 100%;
    background-position: top center;
    padding-top: 0;
...
/* --- RESPONSIVE 2016-04-13 22:28 Addeect --- */
    @media screen and (max-width:801px){ 
        ...
        .te_section5{
          padding: 206px 0 30px 0 !important;
          background-image: url('<?php echo base_url("assets/img/ca_contact_us_bg0.jpg") ?>') !important;
